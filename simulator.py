...
def getscores(k):
    ...
    for element in temp:
        if element in scores:
            scores.remove(element)  #scores from temp are removed from global scores list
...
print("PlayerID \tMatch1\tMatch2\tMatch3\tMatch4\tMatch5\tMatch6\tMatch7\tMatch8\tMatch9\tMatch10\tAverage")
for i in range(0,11):
